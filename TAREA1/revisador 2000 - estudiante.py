...
try :    
    ...
    with open("IO_Esperado.txt", encoding="ANSI") as a:
        lista = a.readlines()
...
for alumno in alumnos:
    ...
    if not formato:
        ...
        code = ''
        try :
            with open('./estudiantes/'+alumno,'r', encoding="utf-8") as file:
                code = file.read()
        except:
            with open('./estudiantes/'+alumno,'r', encoding="ANSI") as file:
                code = file.read()
        ...
        try :
            with open("log.out",'a', encoding="utf-8") as file:
                 file.write("\n\n"+code_out)
        except :
            with open("log.out",'a', encoding="ANSI") as file:
                 file.write("\n\n"+code_out)
